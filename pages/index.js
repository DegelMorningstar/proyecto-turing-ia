                ...
                <div className="contact-wrapper">
                  ...
                  <form id="contact-form" className="form-horizontal" role="form">
                    ...
                    <div className="form-group">
                      <div className="col-sm-12">
                        <input type="text" className="form-control" id="name" placeholder="Tu nombre" name="name" required />
                      </div>
                    </div>

                    <div className="form-group">
                      <div className="col-sm-12">
                        <input type="email" className="form-control" id="email" placeholder="Tu correo" name="email" required />
                      </div>
                    </div>

                    <div className="form-group">
                      <div className="col-sm-12">
                        <input type="number" className="form-control" id="celnumber" placeholder="Numero de telefono" name="phonenumer" required />
                      </div>
                    </div>

                    <div className="form-group">
                      <div className="col-sm-12">
                        <input type="text" className="form-control" id="enterprise" placeholder="Tu empresa (Opcional)" name="enterprise" />
                      </div>
                    </div>
                  ...
                  <div className="direct-contact-container">
                    ...
                    <ul className="social-media-list">
                      ...
                      <li>
                        <Link href="https://www.instagram.com/ia_turing/">
                          <a target="_blank" className="contact-icon">
                      ...
                      <li>
                        <Link href="https://twitter.com/IaTuring">
                          <a target="_blank" className="contact-icon">
                      ...
                      <li>
                        <Link href="https://www.facebook.com/Turing-Inteligencia-Artificial-106802521718296">
                          <a className="contact-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
